...
import com.example.emos.wx.controller.form.ApprovalMeetingForm;
...
public class MeetingApprovalController {
    ...
    public R searchNeedApproval(@RequestHeader("token")String token){
        ...
        Integer deptManagerId = userDao.searchDeptManagerIdByUserId(userId);
        ArrayList  list = meetingService.searchNeedApprovalMeeting(deptManagerId);
