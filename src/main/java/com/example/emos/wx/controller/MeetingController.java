...
public class MeetingController {
    ...
    public R searchMyMeetingByPage(@Valid @RequestBody SearchMyMeetingListByPageForm form, @RequestHeader("token")String token){
    ...
    public R insertMeeting(@Valid @RequestBody InsertMeetingForm form, @RequestHeader("token") String token){
        ...
        entity.setInstanceId(UUID.randomUUID().toString().replace("-",""));
    ...
    public R updateMeetingInfo(@Valid @RequestBody UpdateMeetingInfoForm form){
        ...
        param.put("instanceId", UUID.randomUUID().toString().replace("-",""));
        param.put("status", 1);
